...
TIER_CONFIG = {
    ...
    ContentTier.TIER_4_BOTTOM_REVEAL: {
        "price": 92.46,
        "name": "Bottom Reveal",
        "description": "Top back on, bottoms off. Not too explicit on bottom half.",
        "explicitness": "bottom_implied",
        "what_shows": "Bottoms removed, top half covered, teasing bottom angles",
        "what_doesnt_show": "Not fully explicit bottom shots, suggestive not graphic",
        "images_per_bundle": (3, 4),
        "videos_per_bundle": (1, 2),
    ...
    ContentTier.TIER_5_FULL_EXPLICIT: {
        ...
        "description": "Fully unclothed. Fingering, playing with tits. No toys, no climax.",
        "explicitness": "full_nude_explicit",
        "what_shows": "Full nudity, fingering, breast play, self-touching",
        "what_doesnt_show": "No toys, no climax, no orgasm",
        "images_per_bundle": (3, 4),
        "videos_per_bundle": (1, 2),
    ...
    ContentTier.TIER_6_CLIMAX: {
        ...
        "name": "Full Climax",
        "description": "Full out: toys, riding, climaxing.",
        "explicitness": "maximum",
        "what_shows": "Toys, riding, climaxing, full explicit content, nothing held back",
